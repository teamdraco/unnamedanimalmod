...
public class UAMSpawnEggItem extends SpawnEggItem {
    public static final List<UAMSpawnEggItem> UNADDED_EGGS = new ArrayList<UAMSpawnEggItem>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public UAMSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColor, final int secondaryColor, final Item.Properties properties) {
