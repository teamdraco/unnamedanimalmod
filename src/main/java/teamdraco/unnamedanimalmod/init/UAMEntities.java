...
public class UAMEntities {
    ...
    public static final RegistryObject<EntityType<LeafySeadragonEntity>> LEAFY_SEADRAGON = create("leafy_seadragon", EntityType.Builder.of(LeafySeadragonEntity::new, EntityClassification.WATER_AMBIENT).sized(0.4f, 0.3f));
    ...
    public static final RegistryObject<EntityType<MudskipperEntity>> MUDSKIPPER = create("mudskipper", EntityType.Builder.of(MudskipperEntity::new, EntityClassification.WATER_CREATURE).sized(0.7f, 0.35f));
