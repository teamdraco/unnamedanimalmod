...
public class UAMItems {
    ...
    public static final RegistryObject<Item> BABY_HUMPHEAD_PARROTFISH_BUCKET = ITEMS.register("baby_humphead_parrotfish_bucket", () -> new BabyHumpheadParrotfishBucketItem(UAMEntities.HUMPHEAD_PARROTFISH, () -> Fluids.WATER, defaultProperties().stacksTo(1)));
