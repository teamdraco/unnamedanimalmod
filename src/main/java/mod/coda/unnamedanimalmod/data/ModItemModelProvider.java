...
public class ModItemModelProvider extends net.minecraftforge.client.model.generators.ItemModelProvider
{
    ...
    protected void registerModels()
    {
        ...
        takeAll(items, i -> i.get() instanceof SpawnEggItem).forEach(this::spawnEggItem);
    ...
    private void spawnEggItem(RegistryObject<Item> i)
    {
        String name = Registry.ITEM.getKey(i.get()).getPath();
        getBuilder(name).parent(new ModelFile.UncheckedModelFile(new ResourceLocation("item/template_spawn_egg")));
    }
