...
import static mod.coda.unnamedanimalmod.Helper.prefix;
...
public class ModBlockStateProvider extends net.minecraftforge.client.model.generators.BlockStateProvider
{
    ...
    {
        super(gen, UnnamedAnimalMod.MOD_ID, exFileHelper);
    }
    ...
    protected void registerStatesAndModels()
    {
        ...
        Helper.takeAll(blocks, b -> b.get() instanceof WallBlock).forEach(this::wallBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof FenceBlock).forEach(this::fenceBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof FenceGateBlock).forEach(this::fenceGateBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof DoorBlock).forEach(this::doorBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof TrapDoorBlock).forEach(this::trapdoorBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof PressurePlateBlock).forEach(this::pressurePlateBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof AbstractButtonBlock).forEach(this::buttonBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof DoublePlantBlock).forEach(this::tallPlantBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof BushBlock).forEach(this::plantBlock);
        Helper.takeAll(blocks, b -> b.get() instanceof LanternBlock).forEach(this::lanternBlock);
