...
public class UAMEntities {
    ...
    public static final RegistryObject<EntityType<HumpheadParrotfishEntity>> HUMPHEAD_PARROTFISH = create("humphead_parrotfish", EntityType.Builder.create(HumpheadParrotfishEntity::new, EntityClassification.WATER_CREATURE).size(1.2f, 0.8f));
    ...
    public static final RegistryObject<EntityType<CapybaraEntity>> CAPYBARA = create("capybara", EntityType.Builder.create(CapybaraEntity::new, EntityClassification.CREATURE).size(1.0f, 1.2f));
